package bombermanN5.src.graphic;
...
public class Sprite {
	...
	// Ovape
	public static Sprite ovape_left1 = new Sprite(DEFAULT_SIZE, 6, 5, SpriteSheet.tiles, 14, 16);
	public static Sprite ovape_left2 = new Sprite(DEFAULT_SIZE, 6, 6, SpriteSheet.tiles, 14, 16);
	public static Sprite ovape_left3 = new Sprite(DEFAULT_SIZE, 6, 7, SpriteSheet.tiles, 14, 16);

	public static Sprite ovape_right1 = new Sprite(DEFAULT_SIZE, 7, 5, SpriteSheet.tiles, 14, 16);
	public static Sprite ovape_right2 = new Sprite(DEFAULT_SIZE, 7, 6, SpriteSheet.tiles, 14, 16);
	public static Sprite ovape_right3 = new Sprite(DEFAULT_SIZE, 7, 7, SpriteSheet.tiles, 14, 16);

	public static Sprite ovape_dead = new Sprite(DEFAULT_SIZE, 7, 8, SpriteSheet.tiles, 14, 16);
